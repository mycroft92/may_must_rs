...
- refactor the executable state carrier to one accumulated reachability formula per program point instead of separate `path_summary` and `facts`, and use oracle-backed projection/elimination at procedure boundaries
