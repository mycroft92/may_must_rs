...
//! [`crate::analysis::interproc::query::ContextualSummaryTable`], which is
...
//! [`crate::analysis::interproc::query::ContextualMustSummary`].
...
/// [`crate::analysis::interproc::query::ContextualSummaryTable`].
...
/// **Re-export of [`crate::analysis::interproc::query::ContextualSummaryTable`].**
///
...
/// merging.
pub use crate::analysis::interproc::query::ContextualSummaryTable as SummaryTables;
